...
if __name__ == '__main__':
    result_print()
# TODO Примеры расписания содержат символы табуляции вместо пробелов, которые ожидает
#  программа. Желательно предусмотреть такую ситуацию и либо разделять строки по символу
#  табуляции либо заменить всю табуляцию в входном файле пробелами.

# TODO Небольшая недоработка в модуле bowling. Если в строке со счётом некорректный символ,
#  например любая буква, отличная от X, программа пытается преобразовать её в число
#  и происходит ошибка.
